                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('crud.create_Estudiante') }}" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail1"
                                                    aria-describedby="emailHelp" name="txtrol" value="Estudiante" readonly>
                                            </div>
                                    ...
                                    @foreach ($datos as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('crud.delete_Estudiante', $item->id) }}"
                                            ...
                                            <div class="modal fade" id="modalEditar{{ $item->id }}"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('crud.update_Estudiante') }}"
                                                                method="post">
                                                                @csrf
                                                                <div class="mb-3">
                                                                    <label for="exampleInputEmail1"
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="exampleInputEmail1"
                                                                        class="form-label">Programa</label>
                                                                    <input type="text" class="form-control"
                                                                        id="exampleInputEmail1"
                                                                        aria-describedby="emailHelp"
                                                                        name="txtprograma"
