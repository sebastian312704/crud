                    ...
                    <body>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('crud.create_Asignacion_Estudiante') }}"
                                            method="post">
                                            @csrf
                                            <div class="mb-3">
                        ...
                        <div class="p-5 table-responsive">
                            ...
                            <button class="btn btn-success" data-bs-toggle="modal"
                                data-bs-target="#modalregistrar">Añadir asignacion estudiante</button>
                                    ...
                                    @foreach ($datos as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('crud.delete_Asignacion_Estudiante', $item->id) }}"
                                            ...
                                            <div class="modal fade" id="modalEditar{{ $item->id }}"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form
                                                                action="{{ route('crud.update_Asignacion_Estudiante') }}"
                                                                method="post">
                                                                @csrf
                                                                <div class="mb-3">
                                                                    <label for="exampleInputEmail1"
