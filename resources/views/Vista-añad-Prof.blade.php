                    ...
                    <body>
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('crud.create_Profesor') }}" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail1"
                                                    aria-describedby="emailHelp" name="txtrol" value="Profesor" readonly>
                                            </div>
                                            <div class="mb-3">
                        ...
                        <div class="p-5 table-responsive">
                            ...
                            <button class="btn btn-success" data-bs-toggle="modal"
                                data-bs-target="#modalregistrar">Añadir profesor</button>
                                    ...
                                    @foreach ($datos as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('crud.delete_Profesor', $item->id) }}"
                                            ...
                                            <div class="modal fade" id="modalEditar{{ $item->id }}"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('crud.update_Profesor') }}"
                                                                method="post">
                                                                @csrf
                                                                <div class="mb-3">
                                                                    <label for="exampleInputEmail1"
