...
<body>
    ...
    <div class="p-5 table-responsive">
        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalregistrar">Añadir estudiante</button>
        <button class="btn btn-success" onclick="window.location='{{ route("crud.index1") }}'">Registrar profesor</button>
                                    ...
                                    <div class="modal-body">
                                        <form action="{{route("crud.update")}}" method="post">
                                            ...
                                            <div class="mb-3">
                                                <label for="exampleInputEmail1" class="form-label">Programa</label>
                                                <input type="text" class="form-control" id="exampleInputEmail1"
                                                    aria-describedby="emailHelp" name="txtprograma" value="{{ $item->programa }}">
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleInputEmail1" class="form-label">Email</label>
                                                <input type="text" class="form-control" id="exampleInputEmail1"
